...
async function reminderChat(req, res) {
  ...
  try {
    ...
    const remiderPrompt = new PromptTemplate({
      ...
      for example:
      answer: 'Your reminder is succesfully created at me ,Now lets chat about your marriage',do you have any surprise plan.,
      datetime: '2023-12-23 15:00:00',
      activities: 'Wedding at Kolkata Marriage Hall',
...
const setReminder = async (paramters, user_id, question) => {
  ...
  try {
    ...
    const setReminder = await Remineder.create({
      user_id: user_id,
      title: activities,
      msg: activities,
      phone: userPhone,
